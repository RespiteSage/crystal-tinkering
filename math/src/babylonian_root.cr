def babylonian_root_method(number_to_find_root_for, initial_guess, approximation_steps)
...
puts babylonian_root_method(number_to_find_root_for, initial_guess, approximation_steps)
